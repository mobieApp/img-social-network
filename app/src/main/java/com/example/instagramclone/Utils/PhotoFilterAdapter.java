...
public class PhotoFilterAdapter extends RecyclerView.Adapter<PhotoFilterAdapter.MyViewHolder> {
    ...
    public PhotoFilterAdapter(Context context, List<ThumbnailItem> thumbnailItemList, ThumbnailsAdapterListener listener) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_effect_item, parent, false);
